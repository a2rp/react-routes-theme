import{d as l,a as w,r as $,j as e,N as t,D as T,E as S,F as P,H as J,w as C,I as E}from"./index-LshBDmDj.js";const c="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",d="var(--card, #111318)",r="var(--border, #23262d)",s="var(--accent, #5aa9ff)",N="var(--accent-soft, rgba(90,169,255,0.15))",h="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",p={Page:l.div`
        padding: 20px;
        color: ${c};
    `,Head:l.header`
        display: grid;
