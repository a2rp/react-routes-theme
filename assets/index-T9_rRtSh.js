import{d as x,r as i,j as e,N as C}from"./index-BM8H5dnP.js";const l="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",d="var(--card, #111318)",o="var(--border, #23262d)",n="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",G="var(--radius, 16px)",h={Page:x.div`
        padding: 24px 0 64px;
        color: ${l};
        max-width: 1200px;
        margin: 0 auto;
