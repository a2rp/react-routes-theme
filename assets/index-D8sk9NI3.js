import{d as x,r as g,j as e,N as l,az as D,L as i,B as y,aA as S,V as C,aB as v,aC as M,aD as T,aE as L,aF as P,aG as R,aH as A,k as B}from"./index-KPinFGVz.js";const n="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",t="var(--card, #111318)",r="var(--border, #23262d)",s="var(--accent, #5aa9ff)",p="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",h={Wrap:x.div`
        width: 100%;
        color: ${n};
        display: flex;
