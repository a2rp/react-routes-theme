import{d as u,u as S,r as j,j as e,N as v}from"./index-BscvFKDB.js";const t="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",m="var(--card, #111318)",r="var(--border, #23262d)",i="var(--accent, #5aa9ff)",N="var(--accent-soft, rgba(90,169,255,0.15))",y="var(--radius, 14px)",g={Page:u.div`
        width: 100%;
        color: ${t};
        padding: 24px 0 64px;
