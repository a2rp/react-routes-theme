import{d as y,a as I,r as c,j as e,N as W,l as B,e as Y,m as U,n as L,o as H,p as q,k as F}from"./index-ZieGIFSx.js";const u="var(--text, #f3f4f6)",N="var(--muted, #a0a0a7)",m="var(--card, #111318)",l="var(--border, #23262d)",a="var(--accent, #5aa9ff)",D="var(--accent-soft, rgba(90,169,255,0.15))",j="var(--danger, #ef4444)",R="var(--radius, 16px)",$={Page:y.div`
        padding: 24px 0 64px;
        color: ${u};
    `,Header:y.header`
        display: flex;
