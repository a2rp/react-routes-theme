import{d as u,u as W,r,j as e,N as R,l as J,e as Z,A as q,w as Q,b as Y,C as K}from"./index-P_7RwasD.js";const m="var(--text, #f3f4f6)",h="var(--muted, #a0a0a7)",j="var(--card, #111318)",o="var(--border, #23262d)",n="var(--accent, #5aa9ff)",D="var(--accent-soft, rgba(90,169,255,0.15))",V="var(--warn, #f59e0b)",z="var(--danger, #ef4444)",p={Page:u.div`
        color: ${m};
        display: grid;
        gap: 16px;
        padding-bottom: 48px;
