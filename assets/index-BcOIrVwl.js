import{d as o,g as P,r as u,j as e,L as s,B as w,t as L,i as V,A as M,q as z,k as E}from"./index-KPinFGVz.js";const l="var(--text, #f3f4f6)",x="var(--muted, #a0a0a7)",m="var(--card, #111318)",r="var(--border, #23262d)",a="var(--accent, #5aa9ff)",d="var(--accent-soft, rgba(90,169,255,0.15))",v="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",F=o.div`
    width: 100%;
    padding: 16px;
    color: ${l};
`,U=o.div`
