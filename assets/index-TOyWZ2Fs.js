import{d as v,s as U,u as F,r as p,j as e,N as a}from"./index-ZieGIFSx.js";const A="var(--bg, #0d1117)",s="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",l="var(--card, #111318)",r="var(--border, #23262d)",o="var(--accent, #5aa9ff)",u="var(--accent-soft, rgba(90,169,255,0.15))",f="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",W=v.div`
    width: 100%;
    display: flex;
