import{d as m,r,j as e,N as u}from"./index-BauM8ZfN.js";const l="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",c="var(--card, #111318)",n="var(--border, #23262d)",t="var(--accent, #5aa9ff)",C="var(--accent-soft, rgba(90,169,255,0.15))",P="var(--radius, 16px)",b={Page:m.div`
        padding: 24px 0 64px;
        color: ${l};
