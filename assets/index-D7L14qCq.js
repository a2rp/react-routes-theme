import{d as P,u as D,r as k,j as s,L as j,N as i}from"./index-BG5XFThy.js";import{F as R,a as $,b as C,c as b,d as f,e as S,f as v,g as N,h as O,i as I,j as L,k as g,l as T,m as M,n as B}from"./index-Dz9H4Q25.js";const o="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",x="var(--card, #111318)",t="var(--border, #23262d)",r="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",V={Page:P.main`
        display: grid;
        gap: 16px;
        color: ${o};
    ...
    `},a=(n,l)=>{const e=n instanceof Date?n:new Date(n),m=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],d=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],p=u=>String(u).padStart(2,"0"),h=`${m[e.getDay()]} ${d[e.getMonth()]} ${p(e.getDate())} ${e.getFullYear()}`;return l?`${h} ${p(e.getHours())}:${p(e.getMinutes())}:${p(e.getSeconds())}hrs`:h},w=n=>{const l=n instanceof Date?n:new Date(n),e=m=>String(m).padStart(2,"0");return`${e(l.getHours())}:${e(l.getMinutes())}:${e(l.getSeconds())}hrs`},z=()=>{const n=D(),l=k.useRef(null),e="2025-10-04T17:53:00.221Z",m="2025-10-04T23:22:55+05:30",d=k.useMemo(()=>new Date,[]),p=a(d),h=a(d,!0),u=()=>{l.current&&(document.body.classList.add("print-section-mode"),window.onafterprint=()=>{document.body.classList.remove("print-section-mode"),window.onafterprint=null},window.print())},F=()=>n("/search");return s.jsxs(V.Page,{children:[s.jsx("style",{children:`
        @media print {
