import{d as N,q as M,u as C,r as v,j as e,N as h}from"./index-ZieGIFSx.js";const p="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",m="var(--card, #111318)",r="var(--border, #23262d)",a="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",k="var(--danger, #ef4444)",y="var(--radius, 16px)",f={Page:N.div`
        padding: 24px 0 64px;
        color: ${p};
