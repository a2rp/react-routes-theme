import{d as w,u as z,r as u,j as e,aR as O,c as U,aS as I,am as V,D as H,b as F,aT as q,N as k,i as A,w as G,R as Q,aU as J,aV as X,aW as Y,x as K,y as W,aP as _}from"./index-LshBDmDj.js";const Z="var(--bg, #0d1117)",m="var(--text, #f3f4f6)",b="var(--muted, #a0a0a7)",h="var(--card, #111318)",x="var(--border, #23262d)",r="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",S="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",C={Page:w.div`
        width: 100%;
        color: ${m};
