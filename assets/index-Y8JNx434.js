import{d as i,u as _,r as u,j as e,N as l}from"./index-CvWKwy17.js";const m="var(--bg, #0d1117)",g="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",h="var(--card, #111318)",n="var(--border, #23262d)",t="var(--accent, #5aa9ff)",v="var(--accent-soft, rgba(90,169,255,0.15))",k="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",E=i.div`
    width: 100%;
    color: ${g};
    display: grid;
