import{d as f,u as L,r as v,j as e,N as g}from"./index-Dvs-eF3B.js";const h="var(--text, #f3f4f6)",x="var(--muted, #a0a0a7)",w="var(--card, #111318)",u="var(--border, #23262d)",c="var(--accent, #5aa9ff)",R="var(--accent-soft, rgba(90,169,255,0.15))",T="var(--radius, 16px)",y={Page:f.div`
        padding: 24px 0 64px;
        color: ${h};
