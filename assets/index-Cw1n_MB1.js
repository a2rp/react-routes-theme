import{d as n,_ as D,a as A,r as x,j as e,N as r}from"./index-Dvs-eF3B.js";const o="var(--text, #f3f4f6)",l="var(--muted, #a0a0a7)",a="var(--card, #111318)",t="var(--border, #23262d)",i="var(--accent, #5aa9ff)",b="var(--accent-soft, rgba(90,169,255,0.15))",k="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",M=n.div`
    width: 100%;
    padding: 16px;
    color: ${o};
`,L=n.header`
