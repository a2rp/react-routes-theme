import{d as p,r as h,j as e,N as y,L as t}from"./index-KPinFGVz.js";const r="var(--text, #f3f4f6)",l="var(--muted, #a0a0a7)",D="var(--bg, #0d1117)",c="var(--card, #111318)",o="var(--border, #23262d)",s="var(--accent, #5aa9ff)",B="var(--accent-soft, rgba(90,169,255,0.15))",m="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",x={Page:p.div`
        width: 100%;
        color: ${r};
        background: ${D};
