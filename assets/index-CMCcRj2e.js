import{d as R,r as c,j as e,N as B}from"./index-DYKZsVvl.js";const x="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",p="var(--card, #111318)",i="var(--border, #23262d)",o="var(--accent, #5aa9ff)",P="var(--accent-soft, rgba(90,169,255,0.15))",f="var(--radius, 16px)",y="var(--danger, #ef4444)",E={Page:R.div`
        color: ${x};
        padding: 20px 0 56px;
