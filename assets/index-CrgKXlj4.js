import{d as p,u as R,a as F,r as l,j as e,N as r,b as H,aI as O,aJ as T,n as E}from"./index-DYKZsVvl.js";import{f as G,e as U,g as q,h as Y}from"./index-Bi3pT-QR.js";const $="var(--bg, #0d1117)",d="var(--text, #f3f4f6)",i="var(--muted, #a0a0a7)",c="var(--card, #111318)",a="var(--border, #23262d)",o="var(--accent, #5aa9ff)",K="var(--accent-soft, rgba(90,169,255,0.15))",x="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",h={Wrap:p.div`
        display: grid;
