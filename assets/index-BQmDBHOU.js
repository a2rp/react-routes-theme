import{d as m,u as F,a as T,r as l,j as e,N as d}from"./index-BscvFKDB.js";const c="var(--text, #f3f4f6)",h="var(--muted, #a0a0a7)",p="var(--card, #111318)",s="var(--border, #23262d)",o="var(--accent, #5aa9ff)",u="var(--accent-soft, rgba(90,169,255,0.15))",$="var(--radius, 16px)",g={Wrapper:m.div`
        color: ${c};
        padding: 28px 0 64px;
    `,Toast:m.div`
        position: sticky;
