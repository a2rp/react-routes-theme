import{d as z,a as F,r as p,j as e,N as m}from"./index-Dm9gfKqL.js";const l="var(--text, #f3f4f6)",i="var(--muted, #a0a0a7)",d="var(--card, #111318)",s="var(--border, #23262d)",r="var(--accent, #5aa9ff)",b="var(--accent-soft, rgba(90,169,255,0.15))",U={Page:z.div`
        color: ${l};
        display: grid;
        gap: 16px;
        padding: 16px;
