import{d as j,u as L,r as g,j as e,N}from"./index-BM8H5dnP.js";const m="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",u="var(--card, #111318)",n="var(--border, #23262d)",t="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",w="var(--radius, 16px)",b={Page:j.div`
        padding: 24px 0 72px;
        color: ${m};
    `,Header:j.header`
        display: flex;
