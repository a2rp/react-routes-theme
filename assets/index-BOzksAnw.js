import{d as f,q as J,u as V,r as h,j as e,N as g}from"./index-Dvs-eF3B.js";const x="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",y="var(--card, #111318)",o="var(--border, #23262d)",i="var(--accent, #5aa9ff)",I="var(--accent-soft, rgba(90,169,255,0.15))",$="var(--danger, #ef4444)",L="var(--radius, 16px)",u={Page:f.div`
        padding: 24px 0 64px;
        color: ${x};
