import{d as _,g as X,r as y,j as e,ao as Z,N as x,ap as ee,aq as se,ar as ae,Q as ie,p as E,as as te,k as re,at as B,L as p,q as ne,au as oe,S as le}from"./index-KPinFGVz.js";import{k as v,A as de}from"./index-BITy2jtG.js";const ce="var(--bg, #0d1117)",o="var(--text, #f3f4f6)",h="var(--muted, #a0a0a7)",c="var(--card, #111318)",t="var(--border, #23262d)",r="var(--accent, #5aa9ff)",g="var(--accent-soft, rgba(90,169,255,0.15))",A="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",pe={Wrap:_.div`
        width: 100%;
        color: ${o};
