import{d as G,u as J,r as t,j as e,N as f,aN as K,e as U,aK as Q,M as Y,aO as Z,n as h,L as i,aL as y,k as X}from"./index-CqBbF2bz.js";const d="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",p="var(--card, #111318)",o="var(--border, #23262d)",r="var(--accent, #5aa9ff)",v="var(--accent-soft, rgba(90,169,255,0.15))",w="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",_={Wrap:G.main`
        width: 100%;
        color: ${d};
