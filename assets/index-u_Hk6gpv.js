import{d as p,u as W,r as d,j as e,L as O,N as h}from"./index-DwhKQ_MC.js";const x="var(--text, #f3f4f6)",b="var(--muted, #a0a0a7)",f="var(--card, #111318)",k="var(--border, #23262d)",o="var(--accent, #5aa9ff)",C="var(--accent-soft, rgba(90,169,255,0.15))",c={Page:p.div`
        padding: 24px 0 64px;
        color: ${x};
        h1 {
            font-size: 22px;
