import{d as k,u as M,r as h,j as e,N as s,K as O,A,w as v,O as S,H as P,e as D,k as T}from"./index-CTSbLEdo.js";const C="var(--bg, #0d1117)",l="var(--text, #f3f4f6)",i="var(--muted, #a0a0a7)",p="var(--card, #111318)",d="var(--border, #23262d)",r="var(--accent, #5aa9ff)",b="var(--accent-soft, rgba(90,169,255,0.15))",B="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",I={Page:k.div`
        color: ${l};
        display: flex;
