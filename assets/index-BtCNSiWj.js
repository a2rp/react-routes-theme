import{d as C,a as S,u as R,r as x,j as e,N as s}from"./index-BauM8ZfN.js";const m="var(--text, #f3f4f6)",j="var(--muted, #a0a0a7)",b="var(--card, #111318)",h="var(--border, #23262d)",i="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",B="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",E={Page:C.main`
        color: ${m};
        width: 100%;
        padding: 16px;
