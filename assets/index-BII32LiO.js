import{d as m,r as y,j as e,N as r}from"./index-Be6a9TQd.js";const c="var(--text, #f3f4f6)",g="var(--muted, #a0a0a7)",h="var(--card, #111318)",a="var(--border, #23262d)",i="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",b="var(--danger, #ef4444)",D="var(--radius, 16px)",j={Page:m.div`
        display: grid;
        gap: 16px;
        color: ${c};
    `,Header:m.header`
