import{d as l,u as U,r as b,j as e,N as s}from"./index-KPinFGVz.js";const y="var(--bg, #0d1117)",p="var(--text, #f3f4f6)",x="var(--muted, #a0a0a7)",h="var(--card, #111318)",n="var(--border, #23262d)",r="var(--accent, #5aa9ff)",g="var(--accent-soft, rgba(90,169,255,0.15))",c={Page:l.div`
        width: 100%;
