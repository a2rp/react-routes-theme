import{d as h,r as j,u as w,j as e,N as l}from"./index-P_7RwasD.js";const d="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",p="var(--card, #111318)",a="var(--border, #23262d)",s="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",C="var(--radius, 16px)",u={Page:h.div`
        padding: 24px 0 64px;
        color: ${d};
        .breadcrumbs {
            display: flex;
