import{d as v,r as l,j as e,N as y}from"./index-LshBDmDj.js";const c="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",x="var(--card, #111318)",n="var(--border, #23262d)",d="var(--accent, #5aa9ff)",z="var(--accent-soft, rgba(90,169,255,0.15))",B="var(--radius, 16px)",N={Page:v.div`
        padding: 24px 0 64px;
        color: ${c};
    `,Header:v.header`
        display: flex;
