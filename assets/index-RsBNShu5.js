import{d as c,a as I,r as m,j as e,N as s,l as P,M as b,b0 as y,b1 as R,e as q,w as E}from"./index-CqBbF2bz.js";const v="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",d="var(--card, #111318)",n="var(--border, #23262d)",t="var(--accent, #5aa9ff)",L="var(--accent-soft, rgba(90, 169, 255, 0.15))",C="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",l={Page:c.div`
        color: ${v};
        padding: 18px;
