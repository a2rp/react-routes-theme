import{d as c,g as I,r as m,j as e,N as s,q as P,M as b,b9 as y,ba as R,k as q,B as E}from"./index-KPinFGVz.js";const v="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",d="var(--card, #111318)",n="var(--border, #23262d)",t="var(--accent, #5aa9ff)",B="var(--accent-soft, rgba(90, 169, 255, 0.15))",C="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",l={Page:c.div`
        color: ${v};
        padding: 18px;
