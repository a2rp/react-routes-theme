import{d as k,a as T,r as d,j as e,N as l,L as n}from"./index-CvWKwy17.js";const c="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",r="var(--card, #111318)",i="var(--border, #23262d)",o="var(--accent, #5aa9ff)",g="var(--accent-soft, rgba(90,169,255,0.15))",D=k.div`
    width: 100%;
    padding: 16px;
    color: ${c};
