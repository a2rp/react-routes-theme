import{d as l,u as y,r as j,j as e,N as a}from"./index-Dm9gfKqL.js";import{m as $,B as w,a as O,k as C,H as g,I as T,f as I,J as L,j as M,K as W,d as S,L as P}from"./index-BjqOZRWg.js";const c="var(--text, #f3f4f6)",t="var(--muted, #a0a0a7)",n="var(--card, #111318)",o="var(--border, #23262d)",i="var(--accent, #5aa9ff)",v="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",r={Wrap:l.div`
        color: ${c};
        display: block;
        width: 100%;
        padding: 16px;
