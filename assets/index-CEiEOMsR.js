import{d as n,x as M,g as P,r as v,j as e,N as j,o as u,L as d,k as N,B as I,q as B,a5 as z,a6 as D,a7 as L,a8 as X,p as q}from"./index-KPinFGVz.js";const E="var(--bg, #0d1117)",m="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",p="var(--card, #111318)",t="var(--border, #23262d)",o="var(--accent, #5aa9ff)",H="var(--accent-soft, rgba(90,169,255,0.15))",i={Page:n.div`
        width: 100%;
        color: ${m};
    `,StickyBar:n.div`
        position: sticky;
