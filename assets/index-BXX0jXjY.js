import{d as x,r as g,j as e,N as l,at as D,L as i,w as f,au as S,K as C,av as v,aw as M,ax as T,ay as L,az as P,aA as R,aB as A,e as B}from"./index-CvWKwy17.js";const n="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",t="var(--card, #111318)",r="var(--border, #23262d)",s="var(--accent, #5aa9ff)",p="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",h={Wrap:x.div`
        width: 100%;
        color: ${n};
        display: flex;
