import{d as m,r as l,j as e,N as d,t as G,v as B,e as I,w as F,x as H,y as U,l as W,n as q}from"./index-CTSbLEdo.js";const c="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",b="var(--card, #111318)",n="var(--border, #23262d)",s="var(--accent, #5aa9ff)",P="var(--accent-soft, rgba(90,169,255,0.15))",J="var(--radius, 16px)",g={Page:m.div`
        padding: 20px;
        color: ${c};
    `,Header:m.header`
        display: grid;
