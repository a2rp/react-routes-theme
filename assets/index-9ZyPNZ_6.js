import{d as j,q as k,r as x,j as e,N as s}from"./index-DwhKQ_MC.js";const p="var(--text, #f3f4f6)",m="var(--muted, #a0a0a7)",h="var(--card, #111318)",d="var(--border, #23262d)",t="var(--accent, #5aa9ff)",$="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",y="var(--accent-soft, rgba(90,169,255,0.15))",f={Wrap:j.div`
        width: 100%;
        color: ${p};
        display: flex;
