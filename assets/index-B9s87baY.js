import{d as p,u as O,a as R,r as b,j as e,N as t,aC as T,aD as E,e as H,v as I,aE as B,n as D,aF as U,ah as L,$ as S,m as M,l as P,k as F}from"./index-Dvs-eF3B.js";const d="var(--text, #f3f4f6)",i="var(--muted, #a0a0a7)",l="var(--card, #111318)",o="var(--border, #23262d)",r="var(--accent, #5aa9ff)",K="var(--accent-soft, rgba(90,169,255,0.15))",v="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",x={Page:p.div`
        color: ${d};
    `,Breadcrumbs:p.nav`
        display: flex;
        gap: 8px;
