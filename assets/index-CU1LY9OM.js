import{d as N,u as R,r as n,j as e,N as v}from"./index-oZLsTwJy.js";const h="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",g="var(--card, #111318)",r="var(--border, #23262d)",a="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",C={Page:N.div`
        padding: 24px 0 64px;
        color: ${h};
