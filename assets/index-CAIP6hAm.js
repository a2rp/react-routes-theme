import{d as $,r as h,j as e,N as a,i as H,t as W,ar as F,v as U,K as B,e as I,b as K,c as C,ad as Y,as as q,n as T,l as G,m as J,w as x}from"./index-ZieGIFSx.js";const u="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",l="var(--card, #111318)",r="var(--border, #23262d)",t="var(--accent, #5aa9ff)",y="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",A={Wrap:$.div`
        width: 100%;
        color: ${u};
        display: flex;
