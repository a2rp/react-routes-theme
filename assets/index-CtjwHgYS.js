import{d as x,r as h,j as e,N as m}from"./index-B_b4CsLB.js";const l="var(--text, #f3f4f6)",g="var(--muted, #a0a0a7)",c="var(--card, #111318)",r="var(--border, #23262d)",t="var(--accent, #5aa9ff)",P="var(--accent-soft, rgba(90,169,255,0.15))",q={Page:x.div`
        padding: 24px 0 64px;
        color: ${l};
    `,Header:x.header`
        display: flex;
