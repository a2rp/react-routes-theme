import{d as j,r as m,j as e,N as h}from"./index-Dm9gfKqL.js";const b="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",L="var(--card, #111318)",l="var(--border, #23262d)",o="var(--accent, #5aa9ff)",B="var(--accent-soft, rgba(90,169,255,0.15))",f={Page:j.div`
        padding: 24px 0 64px;
        color: ${b};
    `,Header:j.header`
        display: grid;
