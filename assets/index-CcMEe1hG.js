import{d as p,q as T,u as P,r as b,j as e,N as f}from"./index-BauM8ZfN.js";const m="var(--text, #f3f4f6)",x="var(--muted, #a0a0a7)",j="var(--card, #111318)",l="var(--border, #23262d)",d="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",A="var(--radius, 16px)",o={Page:p.div`
        padding: 20px 0 64px;
        color: ${m};
