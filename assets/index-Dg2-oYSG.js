import{d as m,q as B,u as M,r as p,j as s,N as f}from"./index-Dm9gfKqL.js";const n="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",u="var(--card, #111318)",i="var(--border, #23262d)",r="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",g="var(--danger, #ef4444)",$="var(--radius, 14px)",j={Page:m.div`
        padding: 20px;
        color: ${n};
    `,Header:m.header`
        display: flex;
