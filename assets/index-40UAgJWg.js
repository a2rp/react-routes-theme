import{d as y,q as I,u as L,r as h,j as e,N as j}from"./index-DwhKQ_MC.js";const d="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",p="var(--card, #111318)",i="var(--border, #23262d)",r="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",x="var(--danger, #ef4444)",f="var(--radius, 16px)",g={Page:y.div`
        width: 100%;
        padding: 24px 0 64px;
        color: ${d};
