import{d as c,u as D,r as u,j as e,N as o}from"./index-KPinFGVz.js";import{J as L,k as A,j as T,A as G,a as z,o as P,O as R,e as C,h as O,q as I,S as H}from"./index-BITy2jtG.js";const r="var(--text, #f3f4f6)",l="var(--muted, #a0a0a7)",p="var(--card, #111318)",t="var(--border, #23262d)",a="var(--accent, #5aa9ff)",g="var(--accent-soft, rgba(90,169,255,0.15))",x={Page:c.div`
        width: 100%;
        color: ${r};
    `,Breadcrumbs:c.nav`
        margin-bottom: 10px;
