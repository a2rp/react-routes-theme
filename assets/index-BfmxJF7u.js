import{d as g,q as S,u as I,r as v,j as e,N as c}from"./index-B_b4CsLB.js";const o="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",h="var(--card, #111318)",d="var(--border, #23262d)",i="var(--accent, #5aa9ff)",P="var(--accent-soft, rgba(90,169,255,0.15))",T="var(--radius, 16px)",b={Page:g.div`
        padding: 24px 0 64px;
        color: ${o};
