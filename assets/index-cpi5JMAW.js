import{d as p,u as T,s as M,r as b,j as e,ag as A,N as t,b as I,t as E,e as L,w as h,ah as z,a2 as D,n as U,F as P}from"./index-BauM8ZfN.js";const o="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",n="var(--card, #111318)",r="var(--border, #23262d)",a="var(--accent, #5aa9ff)",v="var(--bg, #0d1117)",u="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",x={Page:p.div`
        color: ${o};
        width: 100%;
        display: block;
    `,Header:p.header`
