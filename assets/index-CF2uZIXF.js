import{d as y,u as H,r as p,j as e,N as R}from"./index-B_b4CsLB.js";const m="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",k="var(--card, #111318)",o="var(--border, #23262d)",n="var(--accent, #5aa9ff)",G="var(--accent-soft, rgba(90,169,255,0.15))",P="var(--danger, #ef4444)",f={Page:y.div`
        padding: 24px 0 72px;
        color: ${m};
    `,Header:y.header`
        display: flex;
