import{d as h,q,a as Q,u as K,r as p,j as e,L as r}from"./index-BauM8ZfN.js";const l="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",x="var(--card, #111318)",o="var(--border, #23262d)",t="var(--accent, #5aa9ff)",g="var(--accent-soft, rgba(90,169,255,0.15))",m={Wrap:h.div`
        width: 100%;
        color: ${l};
        display: flex;
