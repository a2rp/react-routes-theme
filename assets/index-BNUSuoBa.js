import{d as o,q as O,r as c,j as e,N as x}from"./index-BscvFKDB.js";const p="var(--text, #f3f4f6)",b="var(--muted, #a0a0a7)",n="var(--card, #111318)",l="var(--border, #23262d)",a="var(--accent, #5aa9ff)",P="var(--accent-soft, rgba(90,169,255,0.15))",h={Page:o.div`
        padding: 24px 0 64px;
        color: ${p};
