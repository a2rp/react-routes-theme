import{d as h,j as e,N as s,L as x}from"./index-Dvs-eF3B.js";const n="var(--text, #f3f4f6)",t="var(--muted, #a0a0a7)",r="var(--card, #111318)",a="var(--border, #23262d)",i="var(--accent, #5aa9ff)",p="var(--accent-soft, rgba(90,169,255,0.15))",j={Wrapper:h.div`
    width: 100%;
    color: ${n};
    padding: 18px;
