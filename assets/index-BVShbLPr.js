import{d as n,u as w,r as g,j as e,N as r,a9 as T,aa as S,ab as L,ac as D,ad as z,ae as b,af as f,ag as N,ah as R,ai as y}from"./index-KPinFGVz.js";const p="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",d="var(--card, #111318)",t="var(--border, #23262d)",l="var(--accent, #5aa9ff)",h="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",a={Page:n.div`
        width: 100%;
        color: ${p};
    `,Header:n.header`
        display: flex;
