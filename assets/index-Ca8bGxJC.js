import{d as j,q as k,u as $,r as N,j as e,N as g,z as w,e as T,A as P,B as A,x as R}from"./index-ZieGIFSx.js";const i="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",x="var(--card, #111318)",r="var(--border, #23262d)",l="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",y="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",v={Page:j.div`
        color: ${i};
        padding: 16px;
    `,Toolbar:j.div`
        display: flex;
