import{d as g,q as I,u as A,r as k,j as e,N as x}from"./index-BscvFKDB.js";const m="var(--text, #f3f4f6)",b="var(--muted, #a0a0a7)",l="var(--card, #111318)",i="var(--border, #23262d)",d="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",c="var(--danger, #ef4444)",T="var(--radius, 16px)",j={Page:g.div`
        padding: 24px 0 60px;
        color: ${m};
