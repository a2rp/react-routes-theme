import{d as o,_ as $,u as O,r as T,j as e,N as i}from"./index-Dvs-eF3B.js";const x="var(--bg, #0d1117)",a="var(--text, #f3f4f6)",t="var(--muted, #a0a0a7)",N="var(--card, #111318)",r="var(--border, #23262d)",d="var(--accent, #5aa9ff)",b="var(--accent-soft, rgba(90,169,255,0.15))",y="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",P=o.div`
    width: 100%;
    color: ${a};
