import{d as p,q as S,u as P,r as f,j as e,L as i}from"./index-Dvs-eF3B.js";const u="var(--text, #f3f4f6)",n="var(--muted, #a0a0a7)",d="var(--card, #111318)",r="var(--border, #23262d)",t="var(--accent, #5aa9ff)",A="var(--accent-soft, rgba(90,169,255,0.15))",m="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",x={Wrap:p.div`
        width: 100%;
        color: ${u};
    `,Toolbar:p.div`
        display: flex;
