import{d as h,s as z,u as I,r as x,j as e,N as g}from"./index-DwhKQ_MC.js";const o="var(--text, #f3f4f6)",v="var(--muted, #a0a0a7)",w="var(--card, #111318)",i="var(--border, #23262d)",a="var(--accent, #5aa9ff)",D="var(--accent-soft, rgba(90,169,255,0.15))",U="var(--danger, #ef4444)",H="var(--warn, #f59e0b)",B="var(--info, #60a5fa)",m={Page:h.div`
        padding: 24px 0 64px;
        color: ${o};
    `,Header:h.header`
        display: flex;
