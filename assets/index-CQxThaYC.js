import{d as n,u as w,r as c,j as e,n as N,N as o,aK as C,aL as f,M as S,L as j,z as M,aM as z,k as R,ad as T}from"./index-CvWKwy17.js";const s="var(--text, #f3f4f6)",a="var(--muted, #a0a0a7)",p="var(--card, #111318)",i="var(--border, #23262d)",r="var(--accent, #5aa9ff)",E="var(--accent-soft, rgba(90,169,255,0.15))",t={Page:n.div`
        width: 100%;
        color: ${s};
    `,Banner:n.div`
        display: flex;
