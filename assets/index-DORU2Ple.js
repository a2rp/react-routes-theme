import{d,u as D,a as M,r as p,j as e,N as r}from"./index-Dm9gfKqL.js";const h="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",m="var(--card, #111318)",a="var(--border, #23262d)",i="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",g="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",t={Page:d.div`
        width: 100%;
        color: ${h};
        display: flex;
