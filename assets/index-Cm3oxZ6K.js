import{d as v,q as R,u as M,a as T,r as d,j as e,N as a}from"./index-ZieGIFSx.js";const m="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",o="var(--card, #111318)",l="var(--border, #23262d)",r="var(--accent, #5aa9ff)",h="var(--accent-soft, rgba(90,169,255,0.15))",I="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",k={Page:v.div`
        width: 100%;
        color: ${m};
        display: block;
