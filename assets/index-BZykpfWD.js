import{d as S,u as L,r as h,j as e,N as i,L as s}from"./index-BauM8ZfN.js";const p="var(--text)",l="var(--muted)",c="var(--card)",a="var(--border)",n="var(--accent)",z="var(--accent-soft)",D={Wrapper:S.div`
        width: 100%;
        color: ${p};
        display: flex;
