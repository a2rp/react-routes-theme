import{d as p,r as g,j as e,N as v}from"./index-P_7RwasD.js";const n="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",h="var(--card, #111318)",s="var(--border, #23262d)",a="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",x="var(--radius, 16px)",u={Page:p.div`
        width: 100%;
