import{d as c,u as I,r as l,j as s,e as H,K as R,aG as B,aH as L,L as e,i as n,w as x}from"./index-BauM8ZfN.js";const $="var(--bg, #0d1117)",h="var(--text, #f3f4f6)",u="var(--muted, #a0a0a7)",o="var(--card, #111318)",r="var(--border, #23262d)",d="var(--accent, #5aa9ff)",g="var(--accent-soft, rgba(90,169,255,0.15))",f="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",i={Page:c.div`
        width: 100%;
        color: ${h};
        display: block;
        padding: 18px;
