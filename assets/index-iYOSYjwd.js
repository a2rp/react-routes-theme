import{d as j,u as z,r as x,j as e,N as f}from"./index-CTSbLEdo.js";const d="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",l="var(--card, #111318)",n="var(--border, #23262d)",t="var(--accent, #5aa9ff)",T="var(--accent-soft, rgba(90,169,255,0.15))",M="var(--radius, 16px)",b={Page:j.div`
        padding: 24px 0 64px;
        color: ${d};
