import{d as n,u as w,r as c,j as e,t as N,N as o,aT as C,aU as j,M as S,L as f,E as M,aV as z,p as R,aj as T}from"./index-KPinFGVz.js";const s="var(--text, #f3f4f6)",a="var(--muted, #a0a0a7)",p="var(--card, #111318)",i="var(--border, #23262d)",r="var(--accent, #5aa9ff)",E="var(--accent-soft, rgba(90,169,255,0.15))",t={Page:n.div`
        width: 100%;
        color: ${s};
    `,Banner:n.div`
        display: flex;
