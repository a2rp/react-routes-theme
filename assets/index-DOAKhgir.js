import{d as w,q as M,u as H,r as c,j as e,N as P}from"./index-DYKZsVvl.js";const v="var(--text, #f3f4f6)",g="var(--muted, #a0a0a7)",u="var(--card, #111318)",o="var(--border, #23262d)",f="var(--accent, #5aa9ff)",D="var(--accent-soft, rgba(90,169,255,0.15))",G="var(--radius, 14px)",N={Page:w.div`
