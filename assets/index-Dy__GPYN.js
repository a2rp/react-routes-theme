import{d as S,u as T,r as g,j as e,N as R}from"./index-DwhKQ_MC.js";const x="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",y="var(--card, #111318)",m="var(--border, #23262d)",n="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",L="var(--radius, 16px)",E={Page:S.div`
        padding: 18px 0 60px;
        color: ${x};
