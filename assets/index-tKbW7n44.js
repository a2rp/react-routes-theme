import{d as $,u as w,r as k,j as e,N as r,L as o}from"./index-BauM8ZfN.js";import{_ as C,a as T,b as S,k as l,T as A,S as F,A as L,D as R,x as P,r as M}from"./index-CzSw6k9g.js";const x="var(--text, #f3f4f6)",t="var(--muted, #a0a0a7)",n="var(--card, #111318)",a="var(--border, #23262d)",i="var(--accent, #5aa9ff)",B="var(--accent-soft, rgba(90,169,255,0.15))",g="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",_={Page:$.div`
        color: ${x};
        display: flex;
