import{d as O,u as T,r as c,j as e,N as r}from"./index-CqBbF2bz.js";import{B as w,a as P,b as S,k as y}from"./index-BGrfC-E0.js";const p="var(--text, #f3f4f6)",a="var(--muted, #a0a0a7)",h="var(--card, #111318)",l="var(--border, #23262d)",i="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",D="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",M={Wrap:O.main`
        width: 100%;
        display: flex;
