import{d as $,j as e,N as a}from"./index-B_b4CsLB.js";const h="var(--bg, #0d1117)",o="var(--text, #f3f4f6)",i="var(--muted, #a0a0a7)",d="var(--card, #111318)",s="var(--border, #23262d)",r="var(--accent, #5aa9ff)",u="var(--accent-soft, rgba(90,169,255,0.15))",b="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",w={Wrap:$.div`
        color: ${o};
        width: 100%;
        padding: 16px;
