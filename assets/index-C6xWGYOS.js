import{d as h,q as S,u as D,r as g,j as e,N as n}from"./index-CvWKwy17.js";const l="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",x="var(--card, #111318)",a="var(--border, #23262d)",r="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",y="var(--danger, #ef4444)",k="var(--radius, 16px)",j={Page:h.div`
        padding: 24px 0 64px;
        color: ${l};
    `,Header:h.header`
        display: grid;
