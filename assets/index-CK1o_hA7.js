import{d as f,r as o,j as e,N as I}from"./index-CTSbLEdo.js";const d="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",m="var(--card, #111318)",l="var(--border, #23262d)",r="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",R="var(--radius, 16px)",v={Page:f.div`
        padding: 24px 0 64px;
        color: ${d};
        code {
