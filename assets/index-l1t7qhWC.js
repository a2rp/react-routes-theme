import{d as E,a as A,r as c,j as e,aP as G,aQ as I,e as O,L as o,aN as R,S as x,l as F,w as H,ad as $,N as s}from"./index-BauM8ZfN.js";const W="var(--bg, #0d1117)",l="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",t="var(--card, #111318)",r="var(--border, #23262d)",i="var(--accent, #5aa9ff)",C="var(--accent-soft, rgba(90,169,255,0.15))",h="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",B={Wrap:E.main`
    width: 100%;
    color: ${l};
    background: ${W};
