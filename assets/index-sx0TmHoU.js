import{d as p,r as y,j as e,N as x,R as P}from"./index-BpMGcZ_2.js";const i="var(--text, #f3f4f6)",m="var(--muted, #a0a0a7)",h="var(--card, #111318)",n="var(--border, #23262d)",a="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",I="var(--danger, #ef4444)",S="var(--radius, 16px)",u={Page:p.div`
        padding: 24px 0 64px;
        color: ${i};
    `,Header:p.header`
        display: flex;
