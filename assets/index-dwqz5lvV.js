import{d as u,q as w,u as R,r as f,j as e,N as c}from"./index-ZieGIFSx.js";const t="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",j="var(--card, #111318)",l="var(--border, #23262d)",a="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",$="var(--radius, 16px)",g={Page:u.div`
        padding: 24px 0 64px;
        color: ${t};
