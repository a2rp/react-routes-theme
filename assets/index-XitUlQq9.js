import{d as c,u as M,r as j,j as e,N as H,L as s}from"./index-P_7RwasD.js";import{x as D,b as z,a as J,o as k,A as C,k as f}from"./index-B9VUTsVq.js";const S="var(--bg, #0d1117)",n="var(--text, #f3f4f6)",h="var(--muted, #a0a0a7)",r="var(--card, #111318)",t="var(--border, #23262d)",a="var(--accent, #5aa9ff)",l="var(--accent-soft, rgba(90,169,255,0.15))",m="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",p={Page:c.div`
        width: 100%;
