import{d as i,u as Q,a as W,r as p,j as e,N as s,L as M}from"./index-DYKZsVvl.js";const d="var(--text)",l="var(--muted)",x="var(--card)",o="var(--border)",n="var(--accent)",L="var(--accent-soft)",q="var(--shadow)",_=i.div`
    width: 100%;
    color: ${d};
`,Y=i.nav`
    display: flex;
