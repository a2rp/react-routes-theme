import{d as c,u as O,r as u,j as e,N as t}from"./index-P_7RwasD.js";const l="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",n="var(--card, #111318)",s="var(--border, #23262d)",r="var(--accent, #5aa9ff)",S="var(--accent-soft, rgba(90,169,255,0.15))",j="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",p={Wrapper:c.div`
        width: 100%;
        color: ${l};
        display: flex;
