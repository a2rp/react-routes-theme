import{d as g,q as R,u as P,a as A,r as y,j as e,N as v}from"./index-DwhKQ_MC.js";const o="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",h="var(--card, #111318)",n="var(--border, #23262d)",r="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",m="var(--danger, #ef4444)",L="var(--radius, 16px)",f={Page:g.div`
        padding: 24px 0 64px;
        color: ${o};
        .breadcrumbs {
            display: flex;
