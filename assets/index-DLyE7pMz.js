import{d as u,u as R,r as N,j as e,N as $}from"./index-BpMGcZ_2.js";const d="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",l="var(--card, #111318)",t="var(--border, #23262d)",a="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",I="var(--danger, #ef4444)",y="var(--radius, 16px)",m={Page:u.div`
        padding: 20px 0 64px;
        color: ${d};
