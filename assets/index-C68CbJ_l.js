import{d as A,r as g,j as e,R as z,N as f}from"./index-Dvs-eF3B.js";const y="var(--text, #f3f4f6)",u="var(--muted, #a0a0a7)",b="var(--card, #111318)",p="var(--border, #23262d)",r="var(--accent, #5aa9ff)",C="var(--accent-soft, rgba(90,169,255,0.15))",N={Page:A.div`
        padding: 18px 0 64px;
        color: ${y};
