import{d as x,q as I,u as M,r as h,j as e,N as f}from"./index-BauM8ZfN.js";const n="var(--text, #f3f4f6)",l="var(--muted, #a0a0a7)",p="var(--card, #111318)",r="var(--border, #23262d)",i="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",m="var(--danger, #ef4444)",B="var(--radius, 16px)",j={Page:x.div`
        width: 100%;
        color: ${n};
        padding: 20px 0 64px;
