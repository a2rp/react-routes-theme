import{d as h,q as w,u as P,r as b,j as e,N as p}from"./index-BM8H5dnP.js";import{k as A,s as D,d as T,a as C,t as f,u as y,v as k,w as L}from"./index-CVqscwcs.js";const t="var(--text, #f3f4f6)",l="var(--muted, #a0a0a7)",c="var(--card, #111318)",i="var(--border, #23262d)",r="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",v={Page:h.div`
        padding: 20px 0 64px;
        color: ${t};
