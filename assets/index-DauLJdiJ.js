import{d as G,a4 as q,u as E,r as u,j as e,L as d}from"./index-KPinFGVz.js";import{l as w,m as H,c as R,n as K,o as V,e as M,p as I,q as z,r as Y,s as W,a as X,t as J}from"./index-BTHYGNWn.js";const s="var(--text, #f3f4f6)",m="var(--muted, #a0a0a7)",c="var(--card, #111318)",r="var(--border, #23262d)",a="var(--accent, #5aa9ff)",Q="var(--accent-soft, rgba(90,169,255,0.15))",f="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",Z=q`
    box-shadow: 0 0 0 3px ${Q};
`,_={Page:G.div`
        width: 100%;
        min-height: 100%;
        color: ${s};
