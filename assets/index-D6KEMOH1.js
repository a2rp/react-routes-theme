import{d as m,u as $,r as u,j as e,N as n}from"./index-CTSbLEdo.js";const c="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",j="var(--card, #111318)",l="var(--border, #23262d)",r="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",o={Page:m.div`
        padding: 24px 0 64px;
        color: ${c};
