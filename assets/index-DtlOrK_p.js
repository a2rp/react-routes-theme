import{d as f,u as Y,r as g,j as e,N as P}from"./index-Dm9gfKqL.js";const x="var(--text, #f3f4f6)",v="var(--muted, #a0a0a7)",b="var(--card, #111318)",d="var(--border, #23262d)",n="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",R="var(--danger, #ef4444)",T="var(--radius, 16px)",N={Page:f.div`
        padding: 24px 0 64px;
        color: ${x};
