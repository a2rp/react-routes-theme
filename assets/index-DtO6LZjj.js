import{d as b,r as f,j as e,N as C}from"./index-KPinFGVz.js";const x="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",j="var(--card, #111318)",o="var(--border, #23262d)",t="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",P="#f59e0b",A="#ef4444",g={Page:b.div`
        padding: 20px 0 64px;
        color: ${x};
