import{d as r,u as D,r as m,j as e,L as $,N as t}from"./index-ZieGIFSx.js";const p="var(--text, #f3f4f6)",h="var(--muted, #a0a0a7)",c="var(--card, #111318)",d="var(--border, #23262d)",a="var(--accent, #5aa9ff)",x="var(--accent-soft, rgba(90,169,255,0.15))",P="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",A=r.div`
    width: 100%;
    color: ${p};
    display: flex;
