import{d as u,q as C,u as T,r as f,j as s,N as m}from"./index-B_KzNciT.js";const d="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",g="var(--card, #111318)",r="var(--border, #23262d)",l="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",M="var(--radius, 16px)",x={Page:u.div`
        padding: 24px 0 64px;
        color: ${d};
