import{d as c,u as z,r as m,j as e,N as n,e as L,b as F,k as D,Y as B,o as X,L as h,w as U}from"./index-BauM8ZfN.js";const d="var(--text, #f3f4f6)",j="var(--muted, #a0a0a7)",l="var(--card, #111318)",s="var(--border, #23262d)",t="var(--accent, #5aa9ff)",V="var(--accent-soft, rgba(90,169,255,0.15))",g="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",p={Page:c.div`
        width: 100%;
        color: ${d};
        display: grid;
