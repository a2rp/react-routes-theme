import{d as l,q as se,u as ae,r as h,j as e,N as g}from"./index-LshBDmDj.js";const j="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",t="var(--card, #111318)",r="var(--border, #23262d)",n="var(--accent, #5aa9ff)",J="var(--accent-soft, rgba(90,169,255,0.15))",K="var(--radius, 16px)",Z="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",p={Page:l.div`
        padding: 18px 0 56px;
        color: ${j};
    `,HeadBar:l.header`
        display: grid;
