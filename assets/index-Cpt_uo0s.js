import{d as h,r as d,j as e,N as c}from"./index-P_7RwasD.js";const o="var(--text, #f3f4f6)",b="var(--muted, #a0a0a7)",i="var(--card, #111318)",s="var(--border, #23262d)",r="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",p={Page:h.div`
        display: grid;
        gap: 16px;
        color: ${o};
    `,Header:h.header`
