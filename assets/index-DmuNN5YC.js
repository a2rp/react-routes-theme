import{d as a,a as E,u as J,r as m,j as e,L as i}from"./index-DwhKQ_MC.js";const I="var(--bg, #0d1117)",l="var(--text, #f3f4f6)",x="var(--muted, #a0a0a7)",c="var(--card, #111318)",n="var(--border, #23262d)",t="var(--accent, #5aa9ff)",g="var(--accent-soft, rgba(90,169,255,0.15))",R="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",U=a.div`
    width: 100%;
    color: ${l};
    background: ${I};
`,q=a.div`
