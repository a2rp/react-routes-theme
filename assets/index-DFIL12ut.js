import{d as v,s as V,u as J,r as h,j as e,N as Y}from"./index-LshBDmDj.js";const j="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",N="var(--card, #111318)",n="var(--border, #23262d)",r="var(--accent, #5aa9ff)",D="var(--accent-soft, rgba(90,169,255,0.15))",K="var(--danger, #ef4444)",F="var(--warn, #f59e0b)",ee="var(--radius, 16px)",g={Page:v.div`
        padding: 24px 0 64px;
        color: ${j};
    `,Header:v.header`
        display: flex;
