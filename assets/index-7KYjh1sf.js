import{d as n,q as M,a as P,r as v,j as e,N as j,i as u,L as d,e as N,w as I,l as B,$ as z,a0 as D,a1 as L,a2 as X,k as q}from"./index-CvWKwy17.js";const E="var(--bg, #0d1117)",m="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",p="var(--card, #111318)",t="var(--border, #23262d)",o="var(--accent, #5aa9ff)",H="var(--accent-soft, rgba(90,169,255,0.15))",i={Page:n.div`
        width: 100%;
        color: ${m};
    `,StickyBar:n.div`
        position: sticky;
