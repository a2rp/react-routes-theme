import{d as v,u as I,g as P,r as o,j as e,N as U}from"./index-KPinFGVz.js";const m="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",C="var(--card, #111318)",u="var(--border, #23262d)",l="var(--accent, #5aa9ff)",A="var(--accent-soft, rgba(90,169,255,0.15))",w="var(--danger, #ef4444)",N={Page:v.div`
        padding: 24px 0 64px;
        color: ${m};
