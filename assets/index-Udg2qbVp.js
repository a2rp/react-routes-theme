import{d as r,u as te,a as ae,r as g,j as e,N as s}from"./index-ZieGIFSx.js";import{o as se,F as ie,r as F,X as R,Y as U,q as O,x as z,a as G}from"./index-Bn1vHglI.js";const ne="var(--bg, #0d1117)",p="var(--text, #f3f4f6)",m="var(--muted, #a0a0a7)",x="var(--card, #111318)",o="var(--border, #23262d)",a="var(--accent, #5aa9ff)",W="var(--accent-soft, rgba(90,169,255,0.15))",oe=r.div`
    width: 100%;
    color: ${p};
`,re=r.div`
    display: flex;
