import{d as g,r as n,j as e,N as T}from"./index-B_b4CsLB.js";const i="var(--text, #f3f4f6)",b="var(--muted, #a0a0a7)",x="var(--card, #111318)",o="var(--border, #23262d)",a="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",q="var(--radius, 16px)",j={Page:g.div`
        display: grid;
        gap: 16px;
        color: ${i};
    `,Header:g.header`
