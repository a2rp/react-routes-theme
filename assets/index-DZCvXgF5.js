import{d as i,r as b,j as e,N as a}from"./index-KPinFGVz.js";const c="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",d="var(--card, #111318)",o="var(--border, #23262d)",t="var(--accent, #5aa9ff)",m="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",n={Wrap:i.div`
        display: grid;
        gap: 16px;
        padding: 16px;
        color: ${c};
