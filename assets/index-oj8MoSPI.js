import{d as c,u as z,r as x,j as s,N as l}from"./index-ZieGIFSx.js";import{a2 as L,b as r,a as V,m as k,a3 as d,k as t,a4 as w,a5 as y,D as H}from"./index-Bn1vHglI.js";const p="var(--text, #f3f4f6)",j="var(--muted, #a0a0a7)",g="var(--card, #111318)",n="var(--border, #23262d)",i="var(--accent, #5aa9ff)",E="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",T=c.div`
    width: 100%;
    color: ${p};
    display: block;
    padding: 18px;
