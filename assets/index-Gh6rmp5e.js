import{d as g,u as C,r as j,j as e,N as a}from"./index-CvWKwy17.js";const l="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",o="var(--card, #111318)",r="var(--border, #23262d)",i="var(--accent, #5aa9ff)",v="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",N={Page:g.div`
        color: ${l};
        padding: 18px;
