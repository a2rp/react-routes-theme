import{d as A,u as B,r as f,j as e,N as i,e as H,A as E,F as L,l as M,L as t,n as $,b as z,o as I}from"./index-ZieGIFSx.js";const p="var(--text, #f3f4f6)",x="var(--muted, #a0a0a7)",l="var(--card, #111318)",r="var(--border, #23262d)",s="var(--accent, #5aa9ff)",b="var(--accent-soft, rgba(90,169,255,0.15))",y="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",O={Wrap:A.div`
        color: ${p};
        width: 100%;
        display: flex;
