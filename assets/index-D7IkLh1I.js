import{d as j,r as c,j as t,N as D}from"./index-DwhKQ_MC.js";const l="var(--text, #f3f4f6)",v="var(--muted, #a0a0a7)",i="var(--card, #111318)",o="var(--border, #23262d)",r="var(--accent, #5aa9ff)",K="var(--accent-soft, rgba(90,169,255,0.15))",T="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",S="var(--radius, 12px)",k={Page:j.div`
        padding: 16px;
        color: ${l};
    `,Header:j.header`
        display: grid;
