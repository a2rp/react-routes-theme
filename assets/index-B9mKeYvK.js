import{d as c,r as l,j as e,N as w}from"./index-P_7RwasD.js";const p="var(--text, #f3f4f6)",i="var(--muted, #a0a0a7)",N="var(--card, #111318)",o="var(--border, #23262d)",a="var(--accent, #5aa9ff)",L="var(--accent-soft, rgba(90,169,255,0.15))",x={Page:c.div`
        padding: 24px 0 64px;
        color: ${p};
    `,Header:c.header`
        display: flex;
