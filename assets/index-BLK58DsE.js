import{d as n,r as m,j as e,N as c}from"./index-Dvs-eF3B.js";const l="var(--text, #f3f4f6)",x="var(--muted, #a0a0a7)",v="var(--card, #111318)",d="var(--border, #23262d)",t="var(--accent, #5aa9ff)",T="var(--accent-soft, rgba(90,169,255,0.15))",U="var(--radius, 16px)",N="#f59e0b",S="#ef4444",r={Page:n.div`
        padding: 24px 0 64px;
        color: ${l};
