import{d as j,r as h,j as e,L as s}from"./index-CqBbF2bz.js";const t="var(--text, #f3f4f6)",r="var(--muted, #a0a0a7)",p="var(--card, #111318)",a="var(--border, #23262d)",i="var(--accent, #5aa9ff)",m="var(--accent-soft, rgba(90,169,255,0.15))",g="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",f={Page:j.main`
        color: ${t};
        width: 100%;
        display: flex;
