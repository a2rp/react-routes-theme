import{d as h,u as L,r as p,j as e,N as b}from"./index-CqBbF2bz.js";const d="var(--text, #f3f4f6)",u="var(--muted, #a0a0a7)",l="var(--card, #111318)",r="var(--border, #23262d)",t="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",$="var(--radius, 16px)",m={Page:h.div`
        padding: 24px 0 64px;
        color: ${d};
    `,Header:h.header`
        display: flex;
