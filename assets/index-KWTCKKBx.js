import{d as t,q as M,r as v,j as e,N as n}from"./index-DYKZsVvl.js";const g="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",h="var(--card, #111318)",o="var(--border, #23262d)",a="var(--accent, #5aa9ff)",N="var(--accent-soft, rgba(90,169,255,0.15))",R=t.div`
    width: 100%;
    color: ${g};
`,T=t.nav`
    display: flex;
