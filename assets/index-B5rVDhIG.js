import{d as a,q as C,u as P,r as b,j as e,N as t}from"./index-DwhKQ_MC.js";const j="var(--bg, #0d1117)",o="var(--text, #f3f4f6)",x="var(--muted, #a0a0a7)",m="var(--card, #111318)",n="var(--border, #23262d)",d="var(--accent, #5aa9ff)",T="var(--accent-soft, rgba(90,169,255,0.15))",v="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",D=a.div`
    color: ${o};
    padding: 16px;
`,I=a.div`
    display: flex;
