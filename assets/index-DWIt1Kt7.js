import{d as l,j as e,M as v,T as p}from"./index-ZieGIFSx.js";import{F as y,a as k,b as $,c as N,d as F,e as I}from"./index-ByaSsC7C.js";const o="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",j="var(--card, #111318)",h="var(--border, #23262d)",a="var(--accent, #5aa9ff)",R="var(--accent-soft, rgba(90,169,255,0.15))",T="var(--radius, 14px)",z="var(--maxw, 1080px)",A={Wrapper:l.div`
        padding: 24px;
        color: ${o};
        max-width: ${z};
        margin: 0 auto;
