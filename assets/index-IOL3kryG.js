import{d as r,u as w,r as f,j as s,N as i,A as b,e as T,w as S,L as a,ad as $,ae as C,C as R,af as I,l as B}from"./index-CqBbF2bz.js";const x="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",m="var(--card, #111318)",n="var(--border, #23262d)",l="var(--accent, #5aa9ff)",G="var(--accent-soft, rgba(90,169,255,0.15))",t={Page:r.div`
        width: 100%;
        color: ${x};
        display: flex;
