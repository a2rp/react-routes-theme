import{d as n,_ as N,r as h,j as e,L as f,N as a}from"./index-BM8H5dnP.js";import{a as w,a1 as C,j as P,k as T,l as y,L as R}from"./index-CVqscwcs.js";const x="var(--text, #f3f4f6)",l="var(--muted, #a0a0a7)",i="var(--card, #111318)",r="var(--border, #23262d)",o="var(--accent, #5aa9ff)",u="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",E=n.div`
    width: 100%;
    color: ${x};
