import{d as y,u as z,r as j,j as e,N as o}from"./index-LshBDmDj.js";const m="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",l="var(--card, #111318)",n="var(--border, #23262d)",i="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",W="var(--bg, #0d1117)",w={Wrap:y.div`
        width: 100%;
        color: ${m};
    `,HeaderBar:y.header`
        display: grid;
