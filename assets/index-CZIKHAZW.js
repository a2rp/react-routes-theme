import{d as x,a as $,r as y,j as e,N as u,L as a}from"./index-BauM8ZfN.js";const k="var(--bg, #0d1117)",c="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",t="var(--card, #111318)",o="var(--border, #23262d)",s="var(--accent, #5aa9ff)",b="var(--accent-soft, rgba(90,169,255,0.15))",m={Page:x.div`
        width: 100%;
        color: ${c};
        background: ${k};
