import{d as _,a as X,r as y,j as e,ai as Z,N as x,aj as ee,ak as se,al as ae,H as ie,k as E,am as te,e as re,an as B,L as p,l as ne,ao as oe,I as le}from"./index-BM8H5dnP.js";import{k as v,A as de}from"./index-CVqscwcs.js";const ce="var(--bg, #0d1117)",o="var(--text, #f3f4f6)",h="var(--muted, #a0a0a7)",c="var(--card, #111318)",t="var(--border, #23262d)",r="var(--accent, #5aa9ff)",g="var(--accent-soft, rgba(90,169,255,0.15))",A="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",pe={Wrap:_.div`
        width: 100%;
        color: ${o};
