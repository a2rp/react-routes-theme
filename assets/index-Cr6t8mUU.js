import{d as t,r as g,j as s,N as r}from"./index-B_b4CsLB.js";const m="var(--text, #f3f4f6)",j="var(--muted, #a0a0a7)",p="var(--card, #111318)",n="var(--border, #23262d)",i="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",y="var(--radius, 16px)",a={Page:t.div`
        padding: 18px;
        color: ${m};
    `,Header:t.header`
        display: grid;
