import{d as h,q as A,r as d,j as e,N as S}from"./index-LshBDmDj.js";const o="var(--text, #f3f4f6)",r="var(--muted, #a0a0a7)",p="var(--card, #111318)",n="var(--border, #23262d)",l="var(--accent, #5aa9ff)",D="var(--accent-soft, rgba(90,169,255,0.15))",u="var(--radius, 12px)",f="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",j={Wrapper:h.div`
        width: 100%;
        color: ${o};
        padding: 16px;
