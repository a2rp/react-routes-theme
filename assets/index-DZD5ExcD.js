import{d as p,q as A,u as P,r as f,j as e,N as n}from"./index-Dvs-eF3B.js";const c="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",g="var(--card, #111318)",r="var(--border, #23262d)",i="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",j="var(--danger, #ef4444)",I="var(--radius, 16px)",x={Page:p.div`
        padding: 24px 0 64px;
        color: ${c};
    `,Header:p.header`
        display: flex;
