import{d as j,r as u,a as Y,j as e,L as i}from"./index-CvWKwy17.js";const B="var(--bg, #0d1117)",$="var(--text, #f3f4f6)",b="var(--muted, #a0a0a7)",h="var(--card, #111318)",l="var(--border, #23262d)",r="var(--accent, #5aa9ff)",V="var(--accent-soft, rgba(90,169,255,0.15))",v={Page:j.div`
        width: 100%;
        color: ${$};
        display: flex;
