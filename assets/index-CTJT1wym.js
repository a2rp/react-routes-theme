import{d as h,u as z,r as d,j as e,N as A}from"./index-BauM8ZfN.js";const n="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",p="var(--card, #111318)",i="var(--border, #23262d)",r="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",S="var(--danger, #ef4444)",C="var(--warn, #f59e0b)",G="var(--radius, 14px)",m={Page:h.div`
        padding: 24px 0 64px;
        color: ${n};
