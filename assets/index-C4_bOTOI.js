import{d as h,q as S,u as P,r as f,j as e,N as n}from"./index-BpMGcZ_2.js";const r="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",p="var(--card, #111318)",l="var(--border, #23262d)",a="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",y="var(--danger, #ef4444)",$="var(--radius, 16px)",j={Page:h.div`
        padding: 24px 0 64px;
        color: ${r};
