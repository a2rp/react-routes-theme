import{d as p,u as T,y as M,r as b,j as e,am as A,N as t,h as I,z as E,k as z,B as h,an as L,a8 as D,t as U,P}from"./index-KPinFGVz.js";const o="var(--text, #f3f4f6)",c="var(--muted, #a0a0a7)",n="var(--card, #111318)",r="var(--border, #23262d)",a="var(--accent, #5aa9ff)",v="var(--bg, #0d1117)",u="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",x={Page:p.div`
        color: ${o};
        width: 100%;
        display: block;
    `,Header:p.header`
