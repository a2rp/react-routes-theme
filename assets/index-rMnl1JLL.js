import{d as x,q as N,u as f,r as y,j as e,N as i}from"./index-CvWKwy17.js";const h="var(--text)",r="var(--muted)",m="var(--card)",l="var(--border)",d="var(--accent)",k="var(--accent-soft)",j="var(--shadow)",b={Wrapper:x.div`
        width: 100%;
        padding: 18px;
