import{d,Z as A,u as P,r as f,j as e,L as t,q as S}from"./index-CqBbF2bz.js";const x="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",p="var(--card, #111318)",n="var(--border, #23262d)",r="var(--accent, #5aa9ff)",c="var(--accent-soft, rgba(90,169,255,0.15))",v="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",M=d.div`
    width: 100%;
    color: ${x};
    padding: 18px;
    display: flex;
