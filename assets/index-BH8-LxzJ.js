import{d as o,q as I,u as K,r as g,j as e,N as l}from"./index-B_b4CsLB.js";const b="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",m="var(--card, #111318)",r="var(--border, #23262d)",i="var(--accent, #5aa9ff)",v="var(--accent-soft, rgba(90,169,255,0.15))",N="var(--radius, 14px)",x={Page:o.div`
        width: 100%;
        color: ${b};
        padding: 20px 0 60px;
