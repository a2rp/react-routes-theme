import{d as p,u as O,g as R,r as b,j as e,N as t,aI as T,aJ as H,k as I,A as E,aK as B,t as D,aL as U,an as L,a5 as S,s as M,q as P,p as F}from"./index-KPinFGVz.js";const d="var(--text, #f3f4f6)",i="var(--muted, #a0a0a7)",l="var(--card, #111318)",o="var(--border, #23262d)",r="var(--accent, #5aa9ff)",K="var(--accent-soft, rgba(90,169,255,0.15))",v="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",x={Page:p.div`
        color: ${d};
    `,Breadcrumbs:p.nav`
        display: flex;
        gap: 8px;
