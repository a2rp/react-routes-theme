import{d as v,u as U,r as b,j as e,N}from"./index-P_7RwasD.js";const x="var(--text, #f3f4f6)",u="var(--muted, #a0a0a7)",y="var(--card, #111318)",c="var(--border, #23262d)",l="var(--accent, #5aa9ff)",I="var(--accent-soft, rgba(90,169,255,0.15))",T="var(--radius, 16px)",f={Page:v.div`
        width: 100%;
        color: ${x};
        padding: 24px 0 64px;
