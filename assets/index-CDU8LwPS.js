import{d as w,u as F,r as u,j as e,N as S,L as s}from"./index-DwhKQ_MC.js";import{aa as A,ab as L,ac as E,a as z,z as O,x as C,k as P}from"./index-iMuACjyt.js";const t="var(--text)",d="var(--muted)",i="var(--card)",n="var(--border)",a="var(--accent)",h="var(--accent-soft)",I="var(--shadow)",T={Page:w.div`
        color: ${t};
        padding: 18px;
