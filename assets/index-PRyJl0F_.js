import{d as m,u as N,r as g,j as e,Y as f,b as $,e as S,N as s,aX as w,aY as C,aZ as T}from"./index-DYKZsVvl.js";import{a as P}from"./index-EA0qabw3.js";const a="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",o="var(--card, #111318)",t="var(--border, #23262d)",i="var(--accent, #5aa9ff)",b="var(--accent-soft, rgba(90,169,255,0.15))",v="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",r={Page:m.div`
        width: 100%;
        color: ${a};
    `,Hero:m.section`
