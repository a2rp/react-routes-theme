import{d as m,q as w,u as $,r as j,j as e,N as b}from"./index-BscvFKDB.js";const o="var(--text, #f3f4f6)",t="var(--muted, #a0a0a7)",l="var(--card, #111318)",i="var(--border, #23262d)",a="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",u={Page:m.div`
        width: 100%;
        padding: 20px 0 64px;
        color: ${o};
