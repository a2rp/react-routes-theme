import{d as h,q as V,u as E,r as $,j as e,N as r}from"./index-DwhKQ_MC.js";const g="var(--text, #f3f4f6)",l="var(--muted, #a0a0a7)",x="var(--card, #111318)",i="var(--border, #23262d)",n="var(--accent, #5aa9ff)",O="var(--accent-soft, rgba(90,169,255,0.15))",P="var(--danger, #ef4444)",m={Page:h.div`
        padding: 18px 0 60px;
        color: ${g};
    `,Header:h.header`
        display: flex;
