import{d as v,u as I,r as b,j as e,N as D}from"./index-KPinFGVz.js";const c="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",m="var(--card, #111318)",n="var(--border, #23262d)",r="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",G="var(--radius, 16px)",N={Wrap:v.div`
        color: ${c};
        padding: 20px 0 80px;
    `,Header:v.header`
        display: flex;
