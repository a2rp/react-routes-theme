import{d as n,u as w,r as g,j as e,N as r,a3 as T,a4 as S,a5 as L,a6 as D,a7 as z,a8 as b,a9 as f,aa as N,ab as R,ac as y}from"./index-BM8H5dnP.js";const p="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",d="var(--card, #111318)",t="var(--border, #23262d)",l="var(--accent, #5aa9ff)",h="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",a={Page:n.div`
        width: 100%;
        color: ${p};
    `,Header:n.header`
        display: flex;
