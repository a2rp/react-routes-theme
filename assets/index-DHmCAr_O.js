import{d as x,q as D,u as S,r as g,j as e,N as p}from"./index-CqBbF2bz.js";const l="var(--text, #f3f4f6)",h="var(--muted, #a0a0a7)",j="var(--card, #111318)",t="var(--border, #23262d)",i="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",f="var(--danger, #ef4444)",P="var(--radius, 16px)",b={Page:x.div`
        padding: 24px 0 64px;
        color: ${l};
    `,Header:x.header`
        display: flex;
