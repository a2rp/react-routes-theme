import{d as v,r as m,u as M,j as e,N}from"./index-BM8H5dnP.js";const t="var(--text, #f3f4f6)",u="var(--muted, #a0a0a7)",c="var(--card, #111318)",n="var(--border, #23262d)",a="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",I="var(--danger, #ef4444)",$={Page:v.div`
        padding: 24px 0 64px;
        color: ${t};
        .breadcrumbs {
            display: flex;
