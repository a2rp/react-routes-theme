import{d as j,u as J,r as u,j as t,N as U}from"./index-P_7RwasD.js";const x="var(--text, #f3f4f6)",v="var(--muted, #a0a0a7)",f="var(--card, #111318)",c="var(--border, #23262d)",n="var(--accent, #5aa9ff)",A="var(--accent-soft, rgba(90,169,255,0.15))",q="var(--radius, 16px)",y={Page:j.div`
        padding: 24px 0 64px;
        color: ${x};
