import{d as m,s as z,u as W,r as l,j as e,N as j}from"./index-CTSbLEdo.js";const w="var(--text, #f3f4f6)",g="var(--muted, #a0a0a7)",$="var(--card, #111318)",d="var(--border, #23262d)",i="var(--accent, #5aa9ff)",D="var(--accent-soft, rgba(90,169,255,0.15))",I="var(--danger, #ef4444)",u={Page:m.div`
        padding: 24px 0 64px;
        color: ${w};
