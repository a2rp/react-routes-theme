import{d,q as P,u as A,r as b,j as e,N as u}from"./index-B_b4CsLB.js";const h="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",g="var(--card, #111318)",r="var(--border, #23262d)",t="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",C="var(--radius, 16px)",I="var(--danger, #ef4444)",B="var(--warn, #f59e0b)",l={Page:d.div`
        padding: 24px 0 64px;
        color: ${h};
