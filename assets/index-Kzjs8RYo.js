import{d as c,a as B,r as g,j as e,N as p,L as a}from"./index-Dvs-eF3B.js";const u="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",x="var(--card, #111318)",r="var(--border, #23262d)",s="var(--accent, #5aa9ff)",$="var(--accent-soft, rgba(90,169,255,0.15))",j="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",o={Wrap:c.div`
        color: ${u};
        display: flex;
