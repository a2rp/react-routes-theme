import{d as w,u as z,r as u,j as e,a_ as O,i as U,a$ as M,as as H,K as V,h as F,b0 as q,N as k,o as A,B as G,R as Q,b1 as Y,b2 as J,b3 as K,C as X,D as _,aY as W}from"./index-KPinFGVz.js";const Z="var(--bg, #0d1117)",m="var(--text, #f3f4f6)",b="var(--muted, #a0a0a7)",h="var(--card, #111318)",x="var(--border, #23262d)",r="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",S="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",C={Page:w.div`
        width: 100%;
        color: ${m};
