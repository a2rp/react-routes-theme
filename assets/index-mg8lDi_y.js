import{d as o,q as P,u as D,r as y,j as e,N as x}from"./index-BM8H5dnP.js";const t="var(--text, #f3f4f6)",l="var(--muted, #a0a0a7)",h="var(--card, #111318)",i="var(--border, #23262d)",r="var(--accent, #5aa9ff)",N="var(--accent-soft, rgba(90,169,255,0.15))",j="var(--danger, #ef4444)",T="var(--radius, 16px)",c={Page:o.div`
        padding: 20px;
        color: ${t};
        .breadcrumbs {
            display: flex;
