import{d as C,q as O,u as B,r as l,j as e,N as t,L as N}from"./index-LshBDmDj.js";import{a as I,b as A,x as E,y as V,z as D,k as m,r as z}from"./index-CyH35cVY.js";const o="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",p="var(--card, #111318)",r="var(--border, #23262d)",n="var(--accent, #5aa9ff)",h="var(--accent-soft, rgba(90,169,255,0.15))",S="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",P={Wrap:C.div`
        color: ${o};
        width: 100%;
        padding: 16px;
