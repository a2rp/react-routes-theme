import{d as u,r as c,j as e,N as f}from"./index-CqBbF2bz.js";const n="var(--text, #f3f4f6)",m="var(--muted, #a0a0a7)",p="var(--card, #111318)",o="var(--border, #23262d)",r="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",$="var(--radius, 16px)",x={Page:u.div`
        padding: 24px 0 64px;
        color: ${n};
    `,Header:u.header`
        display: flex;
