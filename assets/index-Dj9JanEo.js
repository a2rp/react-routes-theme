import{d as j,u as H,r as c,j as e,N}from"./index-COs07DQL.js";const d="var(--text, #f3f4f6)",m="var(--muted, #a0a0a7)",x="var(--card, #111318)",o="var(--border, #23262d)",n="var(--accent, #5aa9ff)",k="var(--accent-soft, rgba(90,169,255,0.15))",D="var(--danger, #ef4444)",T="var(--radius, 16px)",g={Page:j.div`
    padding: 24px 0 64px;
    color: ${d};
