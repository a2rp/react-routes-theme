import{d,r as m,j as e,N as s,e as q,b as S,a_ as y,at as F,a$ as C}from"./index-BauM8ZfN.js";const l="var(--text, #f3f4f6)",u="var(--muted, #a0a0a7)",g="var(--card, #111318)",c="var(--border, #23262d)",n="var(--accent, #5aa9ff)",w="var(--accent-soft, rgba(90,169,255,0.15))",v="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",I=d.div`
    width: 100%;
    color: ${l};
