import{d as b,r as u,j as e,N as g}from"./index-BscvFKDB.js";const c="var(--text, #f3f4f6)",h="var(--muted, #a0a0a7)",x="var(--card, #111318)",i="var(--border, #23262d)",r="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",z="var(--radius, 16px)",f={Page:b.div`
        padding: 18px;
        color: ${c};
    `,Header:b.header`
        display: grid;
