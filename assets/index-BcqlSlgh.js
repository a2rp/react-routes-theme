import{d as m,q as v,u as f,r as N,j as e,N as l}from"./index-BauM8ZfN.js";const c="var(--text, #f3f4f6)",d="var(--muted, #a0a0a7)",j="var(--card, #111318)",i="var(--border, #23262d)",n="var(--accent, #5aa9ff)",y="var(--accent-soft, rgba(90,169,255,0.15))",k="var(--radius, 16px)",$="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",g={Page:m.div`
        padding: 24px 0 64px;
        color: ${c};
