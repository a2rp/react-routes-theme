import{d as p,u as S,r as u,j as e,N as T,L as i}from"./index-LshBDmDj.js";const d="var(--text, #f3f4f6)",o="var(--muted, #a0a0a7)",n="var(--card, #111318)",r="var(--border, #23262d)",a="var(--accent, #5aa9ff)",f="var(--accent-soft, rgba(90,169,255,0.15))",g="var(--shadow, 0 10px 30px rgba(0,0,0,.35))",x={Page:p.div`
        width: 100%;
        color: ${d};
    `,HeaderBar:p.div`
        display: flex;
