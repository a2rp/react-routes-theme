import{d as g,q as T,u as S,r as y,j as e,N as j}from"./index-BM8H5dnP.js";const t="var(--text, #f3f4f6)",p="var(--muted, #a0a0a7)",h="var(--card, #111318)",r="var(--border, #23262d)",i="var(--accent, #5aa9ff)",C="var(--accent-soft, rgba(90,169,255,0.15))",v="var(--danger, #ef4444)",P="var(--radius, 16px)",N={Page:g.div`
        padding: 24px 0 64px;
        color: ${t};
    `,Header:g.header`
        display: flex;
